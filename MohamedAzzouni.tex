...
\begin{cventries}
    ...
    { \href{https://play.google.com/store/apps/details?id=com.easysoftin.easyup}{Easy Upnp on Google Play Link} } % Location
    { \href{https://bitbucket.org/easysoftin/easyup/src/master/}{Easy Upnp Source on Gitthub} } % Location
    {Nov. 2012} % Date(s)
    { % Description(s) of experience/contributions/knowledge
        \begin{cvitems}
