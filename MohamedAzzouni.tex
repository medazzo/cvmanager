...
\colorlet{aPMATwesome}{awesome-red} % Default colors include: awesome-emerald, awesome-skyblue, awesome-red, awesome-pink, awesome-orange, awesome-nephritis, awesome-concrete, awesome-darknight
...
\name{Mohamed}{Azzouni}
\address{rue Jesse Owens , Saint Denis}
...
%\twitter{@twit}
\position{Senior Embedded Software Engineer{\enskip\cdotp\enskip}Set Top Boxes - Security - DRM - Streaming - OTT - Android } % Your expertise/fields
