...
%\twitter{@twit}
\position{Senior Software Engineer{\enskip\cdotp\enskip} Linux/Yocto - STB/DRM/OTT - Java/kotlin/Spring -  Javascript/Typescript/Nodejs/Angular/Reacts/ExpressJs - Jenkins/Gitlab/Github/DevOps} % Your expertise/fields
...
\begin{cvskills}
    ...
    \cvskill
    {Embedded} % Category
    { Android: NDK/SDK/JNI, STB:Middleware \& Drivers, OpenEmbedded:Yocto \& Bitbacket}
